...
<section class="content">
    <div class="site">
        ...
        <label><a href="<?php echo __SADMIN__?>/Material/index">规格管理</a>&nbsp;>&nbsp;<a href="#">添加规格</a></label>
    </div>
    <div class="addBox form_submit">
        <div class="inputBox">
            <p class="left">物料名称：</p>
            <p class="right">
                <input type="text" name="materialsName" placeholder="规格名" value="" />
            </p>
        </div>
        <div class="inputBox">
        ...
        <button class="btn btn-success sure ajax-post" type="button" pos="<?php echo __SADMIN__?>/Material/save_add">确认添加</button>
    </div>
</section>
