    ...
    <div class="navBox">
        <div class="tableBox">
            <div class="searchBox search-form">
                <label style="width: 12%;float: left">用户：<?php echo $tel?></label>
                ...
                <div class="form-group son btnbox" style="float: right">
                    <button class="btn btn-success" type="button" id="search" pos="<?php echo __SADMIN__?>/Userdatastatic/detail/tel/<?php echo $tel;?>">搜索</button>
                    <button class="btn btn-info" type="button" id="export" pos="<?php echo __SADMIN__?>/Userdatastatic/detail_export/tel/<?php echo $tel;?>">导出</button>
                </div>
            </div>
