...
<section class="content">
    <div class="site">
        ...
        <label><a href="<?php echo __SADMIN__?>/Bonus/index">充值奖品管理</a>&nbsp;>&nbsp;<a href="#">添加充值奖品</a></label>
    </div>
    <div class="addBox form_submit">
        <div class="inputBox">
            <p class="left">充值奖品名称：</p>
            <p class="right">
                <input type="text" name="type_name" placeholder="奖品名" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">充值数量：</p>
            <p class="right">
                <input type="text" name="chargenum" placeholder="充值数量" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">赠送数量：</p>
            <p class="right">
                <input type="text" name="sendnum" placeholder="赠送数量" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">最小使用数：</p>
            <p class="right">
                <input type="text" name="min_amount" placeholder="最小使用数" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">最大使用数：</p>
            <p class="right">
                <input type="text" name="max_amount" placeholder="最大使用数" value="" />
            </p>
        </div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend input-group">
                                    ...
                                    <input type="text" readonly  name="use_start_date" class="form-control birthday" value="<?php echo date('Y-m-d',time())?>" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend input-group">
                                    ...
                                    <input type="text" readonly  name="use_end_date" class="form-control birthday" value="<?php echo date('Y-m-d',time())?>" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
        ...
        <button class="btn btn-success sure ajax-post" type="button" pos="<?php echo __SADMIN__?>/Bonus/save_add">确认添加</button>
    </div>
</section>
