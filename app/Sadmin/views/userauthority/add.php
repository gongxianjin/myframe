...
<section class="content">
    <div class="site">
        ...
        <label><a href="<?php echo __SADMIN__?>/userauthority/index">权限管理</a>&nbsp;>&nbsp;<a href="#">添加管理员</a></label>
    </div>
    <div class="addBox form_submit">
        <div class="inputBox">
            <p class="left">员工姓名：</p>
            <p class="right">
                <input type="text" name="tname" placeholder="员工姓名" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">绑定手机号：</p>
            <p class="right">
                <input type="text" name="phone" placeholder="绑定的手机号" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">新密码：</p>
            <p class="right">
                <input type="password" name="newpwd" placeholder="8-12位数字或英文字符" value="" />
            </p>
        </div>
        <div class="inputBox">
            <p class="left">确认密码：</p>
            <p class="right">
                <input type="password" name="confirm_pwd" placeholder="8-12位数字或英文字符" value="" />
            </p>
        </div>
        <div class="inputBox">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend input-group">
                                    ...
                                    <input type="text" readonly  name="start_time" class="form-control birthday" value="<?php echo date('Y-m-d',time())?>" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend input-group">
                                    ...
                                    <input type="text" readonly name="end_time" class="form-control birthday" value="<?php echo date('Y-m-d',time())?>" />
                                </div>
                            </div>
                        </div>
                    </fieldset>
        ...
        <button class="btn btn-success sure ajax-post" type="button" pos="<?php echo __SADMIN__?>/Userauthority/save_add">确认修改</button>
    </div>
</section>
