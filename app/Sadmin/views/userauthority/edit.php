...
<section class="content">
    <div class="site">
        ...
        <label><a href="<?php echo __SADMIN__?>/userauthority/index">权限管理</a>&nbsp;>&nbsp;<a href="#">修改管理员信息</a></label>
    </div>
    <div class="addBox form_submit">
        ...
        <button class="btn btn-success sure ajax-post" type="button" pos="<?php echo __SADMIN__?>/Userauthority/save_edit">确认修改</button>
    </div>
</section>
