...
<!--            <a href="">实物奖品管理</a>-->
            <a  class="selected"　href="#">娇子币充值管理</a>
...
<!--            <a href="content_JPGL_HB.html">红包发放管理</a>-->
    ...
    <div class="allData setting-form">
        <div class="numBox">
            <div class="num">
                <p class="red int"><input type="text" name="tobacco_charge_max_limit" value="<?php echo $tobacco_charge_max_limit;?>"></p>
            ...
            <div class="num">
                <p class="yellow int"><input type="text" name="tobacco_charge_day_max_limit" value="<?php echo $tobacco_charge_day_max_limit;?>"></p>
                <p class="pName">每日充值上限</p>
            </div>
            <div class="num">
                <p class="blue2 int"><input type="text" name="tobacco_charge_hour_max_limit" value="<?php echo $tobacco_charge_hour_max_limit;?>"></p>
                <p class="pName">每小时充值上限</p>
            </div>
            <div class="num">
                <p class="int sure" id="chargesetting" pos="<?php echo __SADMIN__?>/Tobaccopoints/chargesetting"><img src="<?php echo __SADMIN_BASE__?>/images/sure.png"></p>
        ...
        <div class="tableBox">
            <div class="searchBox search-form">
                ...
                <div class="form-group son btnbox" style="float: right">
                    <button class="btn btn-success" type="button" id="search" pos="<?php echo __SADMIN__?>/Tobaccopoints/index">搜索</button>
                    <button class="btn btn-info" type="button" id="export" pos="<?php echo __SADMIN__?>/Tobaccopoints/export">导出</button>
                </div>
            </div>
            <div class="tableBoxSon">
                <table class="table table-hover" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <?php if($item['laststate'] != 1 && $item['laststate'] != 2):?><th><a href="<?php echo __SADMIN__?>/TobaccoCharge/excuteHandCharge/chargeRecordId/<?php echo $item['id'];?>" style="color:red;">充值</a></th><?php endif;?>
                    </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
