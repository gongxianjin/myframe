...
<section class="content">
    <div class="site">
        ...
        <label><a href="<?php echo __SADMIN__?>/User/index">权限管理</a>&nbsp;>&nbsp;<a href="#">添加管理员</a></label>
    </div>
    <div class="addBox form_submit">
        ...
        <button class="btn btn-success sure ajax-post" type="button" pos="<?php echo __SADMIN__?>/User/save_add">确认修改</button>
    </div>
</section>
