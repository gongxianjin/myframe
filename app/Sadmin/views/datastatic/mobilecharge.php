...
<section class="content">
    ...
    <div class="allData">
        <div class="numBox">
            ...
            <div class="num">
                <a href="<?php echo __SADMIN__?>/Datastatic/mobilecharge" class="int selected"><span>话费充值数据</span></a>
            </div>
        </div>
    </div>
    ...
    <div class="navBox">
        <div class="tableBox">
            <div class="searchBox search-form">
                ...
                <a class="btn btn-success"  href="<?php echo __SADMIN__?>/Datastatic/mobilecharge_init">初始化</a>
                <div class="form-group son btnbox" style="float: right">
                    <button class="btn btn-success" type="button" id="search" pos="<?php echo __SADMIN__?>/Datastatic/mobilecharge">搜索</button>
                    <button class="btn btn-info" type="button" id="export" pos="<?php echo __SADMIN__?>/Datastatic/mobilecharge_export">导出</button>
                </div>
            </div>
