...
<section class="content">
    ...
    <div class="allData">
        <div class="numBox">
            <div class="num">
                <a href="<?php echo __SADMIN__?>/Datastatic/index" class="int selected"><span>抽奖数据</span></a>
            </div>
            <div class="num">
                <a href="<?php echo __SADMIN__?>/Datastatic/tobaccocharge" class="int"><span>娇子币充值数据</span></a>
            </div>
            <div class="num">
    ...
    <div class="navBox">
        <div class="tableBox">
            <div class="searchBox search-form">
                ...
                <a class="btn btn-success"  href="<?php echo __SADMIN__?>/Datastatic/datastatic_init">初始化</a>
                <div class="form-group son btnbox" style="float: right">
                    <button class="btn btn-success" type="button" id="search" pos="<?php echo __SADMIN__?>/Datastatic/index">搜索</button>
                    <button class="btn btn-info" type="button" id="export" pos="<?php echo __SADMIN__?>/Datastatic/export">导出</button>
                </div>
            </div>
...
<!--                        <th>收货地址</th>-->
                    ...
                    <tr>
                        ...
                        <td><?php if($item['phone']):?>是<?php else:?>否<?php endif;?></td>
