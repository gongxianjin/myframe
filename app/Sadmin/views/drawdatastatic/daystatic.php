...
<section class="content">
    ...
    <div class="allData">
        <div class="numBox">
            ...
            <div class="num">
                <a href="<?php echo __SADMIN__?>/Drawdatastatic/daystatic" class="int selected"><span>按日统计</span></a>
            </div>
            <div class="num">
    ...
    <div class="navBox">
        <div class="tableBox">
            <div class="searchBox search-form">
                ...
                <a class="btn btn-success"  href="<?php echo __SADMIN__?>/Drawdatastatic/draw_daystatic_init">初始化</a>
                <div class="form-group son btnbox" style="float: right">
                    <button class="btn btn-success" type="button" id="search" pos="<?php echo __SADMIN__?>/Drawdatastatic/draw_daystatic_init">初始搜索</button>
                    <button class="btn btn-info" type="button" id="export" pos="<?php echo __SADMIN__?>/Drawdatastatic/daystatic_export">导出</button>
                </div>
            </div>
