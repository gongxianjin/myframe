...
class validformdateModel extends model
{

    protected $table = 'xc_validformdate';

    protected $pk = 'id';

    protected $fields = array('id','starttime','endtime','createtime');

    protected $_valid = array(
        array('id',1,'id不能为空','require'),
        array('createtime',1,'createtime不能为空','require')
    );
